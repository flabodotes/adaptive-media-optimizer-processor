...
public class Base64 {
	 ...
	 * The actual number of significant bytes in your array is given by <var>numSigBytes</var>.</p>
	 ...
	 * <code>encoded</code> ByteBuffer. This is an experimental feature. Currently it does not
	...
	/**
	 * Performs Base64 encoding on the <code>raw</code> ByteBuffer, writing it to the
	 * <code>encoded</code> CharBuffer. This is an experimental feature. Currently it does not
	 * pass along any options (such as {@link #DO_BREAK_LINES} or {@link #GZIP}.
	 *
	 * @param raw input buffer
	 * @param encoded output buffer
	 ...
	 *
	 * <p>As of v 2.3, if the object cannot be serialized or there is another error, the method
	 * will throw an java.io.IOException. <b>This is new to v2.3!</b> In earlier versions, it just
	 ...
	 * Encodes a byte array into Base64 notation. Does not GZip-compress data.
	 *
	 * <p>As of v 2.3, if there is an error, the method will throw an java.io.IOException.
	 * <b>This is new to v2.3!</b> In earlier versions, it just returned a null value, but
	 * in retrospect that's a pretty poor way to handle it.</p>
	 *
	 * @param source The data to convert
	 ...
	 * IOException. <b>This is new to v2.3!</b> In earlier versions, it just returned a null value,
	 * but in retrospect that's a pretty poor way to handle it.</p>
	 *
	 * @param source The data to convert
	 * @param off Offset in array where conversion should begin
	 * @param len Length of data to convert
	...
	/**
	 * Decodes four bytes from array <var>source</var> and writes the resulting bytes
	 * (up to three of them) to <var>destination</var>. The source and destination arrays can be
	 ...
	 * <strong>Ignores GUNZIP option, if it's set.</strong> This is not generally a recommended
...
//        }
	 ...
	 * if there was an error. If <tt>loader</tt> is not null, it will be the class loader
	 ...
	 *
	 * <p>As of v 2.3, if there is a error, the method will throw an java.io.IOException.
	 * <b>This is new to v2.3!</b> In earlier versions, it just returned false, but
	 * in retrospect that's a pretty poor way to handle it.</p>
	 *
	...
	public static class InputStream extends java.io.FilterInputStream {
		 ...
		 *   DO_BREAK_LINES: break lines at 76 characters (only meaningful when encoding)</i>
		 * </pre>
		 * <p>
