...
import es.flabo.liferay.hooks.dlo.utils.pngtastic.core.Logger;
...
public class PngtasticCompressionHandler implements PngCompressionHandler {
	...
	public byte[] inflate(ByteArrayOutputStream imageBytes) throws IOException {
		byte[] imageBytesArray = imageBytes.toByteArray();
		imageBytes=null;//clean memory
		ByteArrayInputStream input = new ByteArrayInputStream(imageBytesArray);
